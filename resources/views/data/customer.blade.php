...
<div class="custom-body m-4">
  ...
  <div class="table mt-2">
    ...
    <div class="row">
      ...
      <div class="column"><h4 class="m-0 txt-normal">{{$d->nama_pelanggan}}</h4><h5 class="m-0 txt-thin">last bought on 2019 04 April</h5></div>
      <div class="column"><h4 class="m-0 txt-normal">{{$d->alamat}}</h4><h5 class="m-0 txt-thin">{{$d->nomor_hp}}</h5></div>
      <div class="column">
        <?php
